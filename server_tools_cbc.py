...
from cbc.query_builder import (
    DEFAULT_BOOLEAN_OPERATOR,
    build_cbc_query,
)
from cbc.schema_loader import normalise_search_type
from cbc.validator import CBCValidator
from server_runtime import ServerRuntime

from server_tools_shared import attach_rag_context
...
def register_cbc_tools(mcp: FastMCP, runtime: ServerRuntime) -> None:
    ...
    @mcp.tool
    def cbc_get_examples(category: Optional[str] = None) -> Dict[str, Any]:
